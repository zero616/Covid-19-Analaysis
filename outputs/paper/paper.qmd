...
Some data cleaning is performed, such as renaming column names, filtering and mutating the column, etc. The cleaned data will be analyzed and performed using R (@citeR) with `tidyverse` (@citeTidyverse), `knitr` (@citeKnitr), `dplyr` (@citeDplyr), `ggplot2` (@citeGgplot2). 
